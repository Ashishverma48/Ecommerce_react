...
function Card({ card }) {
  ...
  return (
    <>
      <div className=" w-full h-max  group relative cursor-pointer  rounded-sm shadow-md bg-slate-100">
        ...
        <div className=" absolute top-0 right-0 mr-2 mt-4 z-10 transition-transform duration-300 transform scale-0 group-hover:scale-100">
          <div className="flex flex-col gap-3">
            <div className="p-2  shadow-2xl rounded-full bg-slate-600 text-white    ">
              <AddShoppingCartIcon />
            </div>
